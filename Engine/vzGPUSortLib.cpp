...
namespace vz::gpusortlib
{
	...
	void LoadShaders()
	{
		vz::renderer::LoadShader(ShaderStage::CS, kickoffSortCS, "gpusortlib_kickoffSortCS.cso");
		vz::renderer::LoadShader(ShaderStage::CS, sortCS, "gpusortlib_sortCS.cso");
		vz::renderer::LoadShader(ShaderStage::CS, sortInnerCS, "gpusortlib_sortInnerCS.cso");
		vz::renderer::LoadShader(ShaderStage::CS, sortStepCS, "gpusortlib_sortStepCS.cso");
	...
	void Initialize()
	{
		...
		vz::graphics::GetDevice()->CreateBuffer(&bd, nullptr, &indirectBuffer);
		...
		vz::backlog::post("vz::gpusortlib Initialized (" + std::to_string((int)std::round(timer.elapsed())) + " ms)");
	}
