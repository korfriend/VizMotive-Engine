...
namespace vz::font
{
	...
	struct Params
	{
		...
		vz::Color color; // base color of the text characters
		vz::Color shadowColor; // transparent disables, any other color enables shadow under text
		float h_wrap = -1; // wrap start width (-1 default for no wrap) (logical canvas units)
		int style = 0; // 0: use default font style, other values can be taken from the vz::font::AddFontStyle() funtion's return value
		...
		Params(
			...
			vz::Color color = vz::Color(255, 255, 255, 255),
			vz::Color shadowColor = vz::Color(0, 0, 0, 0)
		) :
	...
	const vz::graphics::Texture* GetAtlas();
	...
	//	in vz::font::Params::cursor
	Cursor Draw(const char* text, size_t text_length, const Params& params, vz::graphics::CommandList cmd);
	Cursor Draw(const wchar_t* text, size_t text_length, const Params& params, vz::graphics::CommandList cmd);
	Cursor Draw(const char* text, const Params& params, vz::graphics::CommandList cmd);
	Cursor Draw(const wchar_t* text, const Params& params, vz::graphics::CommandList cmd);
	Cursor Draw(const std::string& text, const Params& params, vz::graphics::CommandList cmd);
	Cursor Draw(const std::wstring& text, const Params& params, vz::graphics::CommandList cmd);
