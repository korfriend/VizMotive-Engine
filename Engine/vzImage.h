...
namespace vz::image
{
	...
	struct Params
	{
		...
		//	the background tex should be bound with vz::image::SetBackground() beforehand
	...
	void SetBackground(const vz::graphics::Texture& texture);

	// Draw the specified texture with the specified parameters
	void Draw(const vz::graphics::Texture* texture, const Params& params, vz::graphics::CommandList cmd);
