#ifndef VZENGINE_COMMONINCLUDE_H
#define VZENGINE_COMMONINCLUDE_H

// NOTE : ALL SOURCE CODE FROM WICKID ENGINE
// namespace 'wi' is replaced with 'vz' 
// refactoring by DongJoon Kim
