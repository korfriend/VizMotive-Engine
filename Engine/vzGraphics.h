...
namespace vz::graphics
{
	...
	{
		vz::vector<ShaderLibrary> shader_libraries;
		vz::vector<ShaderHitGroup> hit_groups;
	...
	struct RenderPassDesc
	{
		...
		vz::vector<RenderPassAttachment> attachments;
	};
	// Deprecated, kept for back-compat:
	struct RenderPass
	{
