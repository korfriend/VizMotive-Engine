                     ...
                     _In_ int       nCmdShow)
{
	...
	vz::arguments::Parse(lpCmdLine); // if you wish to use command line arguments, here is a good place to parse them...
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CHAR:
		...
		{
		case VK_BACK:
			vz::gui::TextInputField::DeleteFromInput();
			break;
		case VK_RETURN:
			break;
		default:
		{
			...
			vz::gui::TextInputField::AddInput(c);
		}
		break;
		}
		break;
	case WM_INPUT:
		vz::input::rawinput::ParseMessage((void*)lParam);
		break;
	case WM_KILLFOCUS:
