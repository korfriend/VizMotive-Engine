...
namespace vz::shader
{
	enum SHADERTYPE : uint32_t
	{
		...
		CSTYPE_DVR_WITHOUT_KB,
		CSTYPE_DVR_SLICER_2KB,
		CSTYPE_DVR_CURVED_SLICER_2KB,
		CSTYPE_DVR_XRAY_WITHOUT_KB,
		CSTYPE_DVR_XRAY_SLICER_2KB,
		CSTYPE_DVR_XRAY_CURVED_SLICER_2KB,
		CSTYPE_DVR_ZEROTHICK,
		...
		CSTYPE_GS_RADIX_HIST_GAUSSIANS,
		CSTYPE_GS_RADIX_SORT_GAUSSIANS,
		CSTYPE_GS_IDENTIFY_TILE_RANGES,
		CSTYPE_GS_RENDER_GAUSSIAN,
