...
#define SAFE_OPAQUEALPHA 	(half)0.999f		// ERT_ALPHA
...
Fragment MergeFragments(Fragment f_prior, Fragment f_posterior, const in float beta)
{
	...
	if (f_prior.z > zfront_posterior_f) // overlapping test
	{
		...
		half4 vis_out = f_m_prior_vis + f_posterior_vis * ((half)1.f - f_m_prior_vis.a);
