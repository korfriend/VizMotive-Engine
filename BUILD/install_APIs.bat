...
set "highapis=VzComponentAPIs.h VzEngineAPIs.h VzActor.h VzArchive.h VzCamera.h VzGeometry.h VzMaterial.h VzRenderer.h VzScene.h VzTexture.h"
...
for %%F in (%libs%) do (
    xcopy "..\EngineCore\Libs\%%F" "..\Install\vzm2\utils\" /D /Y
)
REM ------------------------------------------
...
robocopy "..\EngineCore\Libs\DirectXMath" "..\Install\vzm2\utils\DirectXMath" /E /XO
REM ------------------------------------------
