...
namespace vz::shader
{
	...
	void LoadShaders()
	{
		...
		jobsystem::Execute(ctx, [](jobsystem::JobArgs args) { LoadShader(ShaderStage::CS, rcommon::shaders[CSTYPE_GS_DUPLICATED_GAUSSIANS], "gs_duplicateWithKeysCS.cso"); });
		jobsystem::Execute(ctx, [](jobsystem::JobArgs args) { LoadShader(ShaderStage::CS, rcommon::shaders[CSTYPE_GS_IDENTIFY_TILE_RANGES], "gs_identifyTileRangesCS.cso"); });
		jobsystem::Execute(ctx, [](jobsystem::JobArgs args) { LoadShader(ShaderStage::CS, rcommon::shaders[CSTYPE_GS_SORT_DUPLICATED_GAUSSIANS], "gs_renderCS.cso"); });
