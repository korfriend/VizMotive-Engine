...
void Example_ImGuiRenderer::Load()
{
	...
	label.font.params.h_align = vz::font::WIFALIGN_CENTER;
	...
	// Load model.
	//vz::scene::LoadModel("../Content/models/teapot.wiscene");
...
void Example_ImGuiRenderer::Update(float dt)
{
	...
	vz::ecs::Entity e_teapot_base = scene.Entity_FindByName("Base");
	vz::ecs::Entity e_teapot_top = scene.Entity_FindByName("Top");
	//assert(e_teapot_base != vz::ecs::INVALID_ENTITY);
	//assert(e_teapot_top != vz::ecs::INVALID_ENTITY);
	...
	//float rotation = dt;
	//if (vz::input::Down(vz::input::KEYBOARD_BUTTON_LEFT))
	//{
	//	transform_base->Rotate(XMVectorSet(0, rotation, 0, 1));
	//	transform_top->Rotate(XMVectorSet(0, rotation, 0, 1));
	//}
	//else if (vz::input::Down(vz::input::KEYBOARD_BUTTON_RIGHT))
	//{
	//	transform_base->Rotate(XMVectorSet(0, -rotation, 0, 1));
	//	transform_top->Rotate(XMVectorSet(0, -rotation, 0, 1));
	//}
